...
$(document).ready(function () {
    ...
    $('.container__list__delete').on('click', function (e) {
        ...
        smoke.confirm ("Do you want to delete the category?", function (result) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    smoke.alert ("Category was deleted!", function (result) {window.location = '';})
    ...
    $('.container__list__button-edit').on('click', function (e) {
        $(".container__new-category").css("display", "none");
        $(".container__edit-category").css("display", "flex");
        var id = $(this).data('id');
        $('#edit-block form').attr('action', '/categories/edit/' + id);
